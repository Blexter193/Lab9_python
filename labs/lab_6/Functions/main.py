from labs.lab_6.Functions.calculations import calculate, special_operations
from labs.lab_6.Functions.memory_functions import get_from_memory, save_to_memory
from labs.lab_6.Settings.AppSettings import DECIMALS
from labs.lab_6 import init
