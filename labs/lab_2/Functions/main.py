from labs.lab_2.Functions.calculations import calculate, special_operations
from labs.lab_2.Functions.memory_functions import get_from_memory, save_to_memory
from labs.lab_2.Settings.AppSettings import DECIMALS
