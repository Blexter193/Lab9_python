from labs.lab_1.Functions.calculations import calculate, special_operations
from labs.lab_1.Functions.memory_functions import get_from_memory, save_to_memory
from labs.lab_1.Settings.AppSettings import DECIMALS
